                ...
                if (price.equals("sorted_by_ascending_price")) {
                    ...
                    if (!category.isEmpty()) {
                        ...
                        if (category.equals("flowers")) {
                            ...
                            // Если категория равная букетам
                        } else if (category.equals("bouquets")) {
                            ...
                            // Если категория равная корзинам
                        } else if (category.equals("baskets")) {
                    ...
                    if (!category.isEmpty()) {
                        ...
                        if (category.equals("flowers")) {
                            ...
                            // Если категория равная букетакм
                        } else if (category.equals("bouquets")) {
